 ...
 *
 * Design goals:
 *  - Never fabricate tasks, owners, or dates.
 *  - Distinguish a *decision* (committed) from *discussion* (explored, not settled).
 *  - Express uncertainty via confidence rather than omitting or inventing.
 *  - Output is consumed by software, so formatting discipline matters.
 */
